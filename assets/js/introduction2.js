$(document).ready(function(){
  $(window).scroll(function(){
    if($(this).scrollTop() > 0){
      ...
      $(".portfolio .flower img").css({"bottom":"450px"})
      $(".portfolio .flower img").css({"left":"470px"})
      $(".portfolio .flower img").css({"transform":"scale(0.4)"})
      $(".portfolio .flower img").css({"border": "0px solid white"})
    }
    else{
      $("video").css({"opacity": "1"})
      ...
      $(".copies-2 #home").css({"bottom": "245px"})
      $(".copies-2").css({"transform": "scale(1)"})
      $(".copies-1").css({"word-spacing":"5px"})
      $(".copies-2").css({"word-spacing":"5px"})
      $(".pages").css({"word-spacing":"5px"})
      $(".portfolio .flower img").css({"bottom":"195px"})
      $(".portfolio .flower img").css({"left":"-85px"})
      $(".portfolio .flower img").css({"transform":"scale(1)"})
      $(".portfolio .flower img").css({"border": "1px solid white"})
      $(".portfolio .flower img").css({"opacity": "1"})
    }
  })
})
