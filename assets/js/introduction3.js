$(document).ready(function(){
  $(window).scroll(function(){
    if($(this).scrollTop() > 0){
      ...
      $(".portfolio .sun img").css({"bottom":"450px"})
      $(".portfolio .sun img").css({"left":"480px"})
      $(".portfolio .sun img").css({"transform":"scale(0.55)"})
